  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.pb-md-0
    .titulo-principal.color-acento-contenido(data-aos="zoom-in-left")
      .titulo-principal__numero
        span 4
      h1 Mantenimiento de #[i software]
              ...
              .col-lg-10        
                .row
                  .col-auto.bg3.px-2.m-1.p-1(data-aos="flip-down")
                    h5.text-center.mb-0 Algunos de estos programas son:

                .row.justify-content-center.text-center
                  .col-lg-3.my-3
                    .bgw.p-4.brad.h-100(data-aos="zoom-in")
                      img.img-a.img-t.mb-3(data-aos="zoom-in")(src='@/assets/curso/temas/64.png', alt='')
                      p(data-aos="fade-down").mb-0 Escritorio remoto de Google Chrome 
                  .col-lg-3.my-3
                    .bgw.p-4.brad.h-100(data-aos="zoom-in")
                      img.img-a.img-t.mb-3(data-aos="zoom-in")(src='@/assets/curso/temas/65.png', alt='')
                      p(data-aos="fade-down").mb-0 TeamViewer 
                  .col-lg-3.my-3
                    .bgw.p-4.brad.h-100(data-aos="zoom-in")
                      img.img-a.img-t.mb-3(data-aos="zoom-in")(src='@/assets/curso/temas/66.png', alt='')
                      p(data-aos="fade-down").mb-0 Iperius remote  
                  .col-lg-3.my-3
                    .bgw.p-4.brad.h-100(data-aos="zoom-in")
                      img.img-a.img-t.mb-3(data-aos="zoom-in")(src='@/assets/curso/temas/67.png', alt='')
                      p(data-aos="fade-down").mb-0 SupRemo Control 
                  .col-lg-3.my-3
                    .bgw.p-4.brad.h-100(data-aos="zoom-in")
                      img.img-a.img-t.mb-3(data-aos="zoom-in")(src='@/assets/curso/temas/68.png', alt='')
                      p(data-aos="fade-down").mb-0 Escritorio remoto de Windows
                  .col-lg-3.my-3
                    .bgw.p-4.brad.h-100(data-aos="zoom-in")
                      img.img-a.img-t.mb-3(data-aos="zoom-in")(src='@/assets/curso/temas/69.png', alt='')
                      p(data-aos="fade-down").mb-0 Apple Remote Desktop 
                  .col-lg-3.my-3
                    .bgw.p-4.brad.h-100(data-aos="zoom-in")
                      img.img-a.img-t.mb-3(data-aos="zoom-in")(src='@/assets/curso/temas/70.png', alt='')
                      p(data-aos="fade-down").mb-0 Ammyy Admin 

            h5(data-aos="fade-down").mb-4 A continuación, lo invitamos a consultar el siguiente video, para ampliar la información.    

            .row.justify-content-center.align-items-center         
              .col-lg-12(data-aos="fade-left")     
                figure
                  .video
                    iframe(width="560" height="315" src="https://www.youtube.com/embed/wbLCC5TUtRM?si=xGBlXu_wQDEfRVnZ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen)                                
</template>
